...
export default function Login() {
  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center bg-[radial-gradient(circle_at_top,_rgba(139,92,246,0.08),_transparent_45%)] px-4 py-10">
      <Card className="w-full max-w-md p-6 sm:p-8">
        <div className="mb-6 text-center">
          ...
          <p className="mt-1 text-sm text-slate-600">Log in to continue to your dashboard.</p>
        </div>
